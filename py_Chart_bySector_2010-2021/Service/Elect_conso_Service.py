...
plt.title('Electricity Consumption in the Service Sector', fontsize=16)
...
plt.savefig(f'{path_savefig}/barchartDetailled_spread_ElectConso_Service.png', transparent=True, dpi=300)
plt.show()
