...
ax = sns.barplot(x=df_final.index, y=df_final['Residential'], palette=colors)
...
plt.savefig(f'{path_savefig}/SimplyBarchart_spread_ElectConso_Residential.png', transparent=True, dpi=300)
plt.show()
