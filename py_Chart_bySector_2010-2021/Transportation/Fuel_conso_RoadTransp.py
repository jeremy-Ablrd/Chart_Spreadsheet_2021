...
plt.title('Fuel Consumption in the Road Transport Sector', fontsize=16)
...
plt.savefig(f'{path_savefig}/BarchartDetailled_spread_FuelConso_RoadTransport.png', transparent=True, dpi=300)
plt.show()
